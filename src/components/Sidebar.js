...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      w-full bg-white fixed top-0 h-full shadow-2xl drop-shadow-2xl md:w-[35vw] xl:max-w=[30vw] transition-all duration-300 z-20 px-4 lg:px-[35px]`}
    >
      ...
      <div className="shadow-sm flex flex-col gap-y-3 mt-6">
        <div className="flex w-full justify-between items-center">
          ...
          <div 
          onClick={clearCart}
          className="cursor-pointer bg-red-600 text-white w-10 h-10 flex justify-center items-center text-xl">
            <FiTrash2/>
          </div>
        </div>
